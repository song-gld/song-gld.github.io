...
function fnDate(){
    var oDiv=document.getElementById("pDate");
    var date=new Date();
...
function life() {
  ...
  var liveDate = parseInt((nowDate - new Date(birthDate))/1000/60/60/24);
  ...
  life.innerHTML = "你今年已经" + old +  "岁了，" + "<br/>" + "迄今为止，你已经在地球上存活了" + liveDate + "天，" + "<br/>" + "你还可以存活" + leftDay + "天" + leftHour + "小时" + leftMinute + "分钟" + leftSecond + "秒。" + "人生百分比：" + persent;
   // + "<br/>" + "<progress value="20"></progress>"
  var pro = document.creatElement("progress");
  pro.setAttribute("value", "20");
  life.appendChild(pro);
}
